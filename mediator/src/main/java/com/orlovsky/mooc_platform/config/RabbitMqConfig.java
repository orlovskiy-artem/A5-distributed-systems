...
import com.orlovsky.mooc_platform.rabbitmqServer.MoocPlatformRabbitMqServer;
...
//    private String host = "localhost";
    ...
    @Bean
    public MoocPlatformRabbitMqServer server() {
        return new MoocPlatformRabbitMqServer();
    }
